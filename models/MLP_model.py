...
#     """
#
#     def __init__(self, in_dims, out_dims, emb_size,time_type="cat", norm=False, act_func='tanh',
#                  dropout=0.5):
#         super(MLP, self).__init__()
#         self.in_dims = in_dims
#         self.out_dims = out_dims
...
#         h = torch.cat([x, emb], dim=-1)  # Concatenate x, time embedding, and environment variable
#         h = self.in_layers(h.detach())
#         h = self.out_layers(h.detach())
#         return h
#
#
# def timestep_embedding(timesteps, dim, max_period=10000):
